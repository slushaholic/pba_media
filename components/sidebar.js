...
export default function SideBar() {
  return (
      ...
      <div className='flex mt-4 max-w-4xl mx-auto'>
        ...
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          ...
          <ul>
            <li><Link href="/"><a className="text-[25px] ml-4 text-gray-200 font-bold">Home</a></Link></li>
          </ul>
        </div>
        ...
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          ...
          <ul>
            <li><Link href="/profile"><a className="text-[25px] ml-4 text-gray-200 font-bold" >Profile</a></Link></li>
          </ul>
        </div>
        ...
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          ...
          <ul>
            ...
            <li><Link href='/directmessage'><a className="text-[25px] ml-4 text-gray-200 font-bold" >Messages</a></Link></li>
          </ul>
        </div>
  ...
  <path d="M5.082 14.254a8.287 8.287 0 00-1.308 5.135 9.687 9.687 0 01-1.764-.44l-.115-.04a.563.563 0 01-.373-.487l-.01-.121a3.75 3.75 0 013.57-4.047zM20.226 19.389a8.287 8.287 0 00-1.308-5.135 3.75 3.75 0 013.57 4.047l-.01.121a.563.563 0 01-.373.486l-.115.04c-.567.2-1.156.349-1.764.441z" /></svg>
      <ul>
        <li><Link href='/about'><a className="text-[15px] ml-4 text-gray-200 font-bold" >About Us</a></Link></li>
      </ul>
    </div>
    <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
        ...
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
            ...
            <path d="M5.082 14.254a8.287 8.287 0 00-1.308 5.135 9.687 9.687 0 01-1.764-.44l-.115-.04a.563.563 0 01-.373-.487l-.01-.121a3.75 3.75 0 013.57-4.047zM20.226 19.389a8.287 8.287 0 00-1.308-5.135 3.75 3.75 0 013.57 4.047l-.01.121a.563.563 0 01-.373.486l-.115.04c-.567.2-1.156.349-1.764.441z" /></svg>
          <ul>
            <li><Link href='/about'><a className="text-[25px] ml-4 text-gray-200 font-bold" >About Us</a></Link></li>
          </ul>
        </div>
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
            ...
            <path d="M5.082 14.254a8.287 8.287 0 00-1.308 5.135 9.687 9.687 0 01-1.764-.44l-.115-.04a.563.563 0 01-.373-.487l-.01-.121a3.75 3.75 0 013.57-4.047zM20.226 19.389a8.287 8.287 0 00-1.308-5.135 3.75 3.75 0 013.57 4.047l-.01.121a.563.563 0 01-.373.486l-.115.04c-.567.2-1.156.349-1.764.441z" /></svg>
          <ul>
            <li><Link href='/'><a className="text-[25px] ml-4 text-gray-200 font-bold" >Share Post</a></Link></li>
          </ul>
        </div>
        <div className="absolute bottom-10 left-0">
          <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
            ...
            <ul>
              <li><Link href='/login'><a className="text-[25px] ml-4 text-gray-200 font-bold" >Login</a></Link></li>
            </ul>
          </div>
          <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
            ...
            <ul>
              <li><Link href='/register'><a className="text-[25px] ml-4 text-gray-200 font-bold" >Register</a></Link></li>
            </ul>
          </div>
        </div>
      </div>
