  ...
  return (
      ...
      <div className='flex mt-4 max-w-4xl mx-auto'>
        ...
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          ...
          <ul>
            <li><Link href="/"className="text-[25px] ml-4 text-gray-200 font-bold">Home</Link></li>
          </ul>
        </div>
        ...
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          ...
          <ul>
            <li><Link href="/profile"className="text-[25px] ml-4 text-gray-200 font-bold">Profile</Link></li>
          </ul>
        </div>
        ...
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          ...
          <ul>
            ...
            <li><Link href='/directmessage'className="text-[25px] ml-4 text-gray-200 font-bold">Messages</Link></li>
          </ul>
        </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9" />
       ...
       <LoginButton />
        ...
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          ...
          <ul>
            <li><Link href='/about'className="text-[25px] ml-4 text-gray-200 font-bold">About Us</Link></li>
          </ul>
        </div>
        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
            ...
            <path d="M5.082 14.254a8.287 8.287 0 00-1.308 5.135 9.687 9.687 0 01-1.764-.44l-.115-.04a.563.563 0 01-.373-.487l-.01-.121a3.75 3.75 0 013.57-4.047zM20.226 19.389a8.287 8.287 0 00-1.308-5.135 3.75 3.75 0 013.57 4.047l-.01.121a.563.563 0 01-.373.486l-.115.04c-.567.2-1.156.349-1.764.441z" /></svg>
          <ul>
            <li><Link href='/'className="text-[25px] ml-4 text-gray-200 font-bold">Share Post</Link></li>
          </ul>
        </div>
        <div className="absolute bottom-10 left-0">
          <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
            ...
            <ul>
              <li><Link href='/login'className="text-[25px] ml-4 text-gray-200 font-bold">Login</Link></li>
            </ul>
          </div>
          <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
            ...
            <ul>
              <li><Link href='/register'className="text-[25px] ml-4 text-gray-200 font-bold">Register</Link></li>
            </ul>
          </div>
        </div>
      </div>
